...
public class ServiceException extends RuntimeException {
    ...
    public HttpStatus httpStatus() {
        return switch (reason) {
            ...
            case S3_UPLOAD_ERROR, UNEXPECTED_ERROR -> HttpStatus.INTERNAL_SERVER_ERROR;
            case UNAUTHORIZED -> HttpStatus.UNAUTHORIZED;
            case ADMIN_CANNOT_CREATE_APPLICATION, ADMIN_CANNOT_DELETE_APPLICATION -> HttpStatus.FORBIDDEN;
            case EMAIL_SENDING_ERROR -> HttpStatus.INTERNAL_SERVER_ERROR;
        };
    }
}
